            ...
            <div class="card user-card">
                <div class="card-body">
                    ...
                    <div class="btn-group mt-3">
                        <a type="button" class="btn btn-sm btn-warning" href="/Order/ChangeStatus?route=OTList&OrderTransId={{ $ot->OrderTransId }}&status=0" data-toggle="modal" data-target="#editModal{{$ot->OrderTransId}}">
                            <i class="fas fa-done">Order Ready</i>
                        </a>
                    </div>
                </div>
            </div>
